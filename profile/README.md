...
graph TB
    ...
    subgraph "Frontend Layer"
        ...
        MAP[Lawyer Map]
        NEWS[News System]
        CONNECT_UI[SPC Connect UI]
    end
    
    subgraph "API Gateway"
        MAIN_API[api-spc-server<br/>Main API]
    end
    ...
    subgraph "Integration Layer"
        ERP[ERP Connector]
        CONNECT_API[SPC Connect API]
        WEATHER[Weather Alert]
    end
    
    subgraph "Specialized Systems"
        WCAT_API[WCAT API]
        DEBT[Debt Collector API]
    end
